...
class Validation extends \Moonspot\Kubernetes\BaseObject {

    /**
     * Expression represents the expression which will be evaluated by CEL.
     * ref: https://github.com/google/cel-spec CEL expressions have access to
     * the contents of the API request/response, organized into CEL variables
     ...
     * the 'authorizer' and configured with the
     *   request resource.
     * 
     * The `apiVersion`, `kind`, `metadata.name` and `metadata.generateName`
     * are always accessible from the root of the object. No other metadata
     ...
     * 
     * Equality on arrays with list type of 'set' or 'map' ignores element
     ...
     * access to all the same variables as the `expression` except for
     * 'authorizer' and 'authorizer.requestResource'. Example: "object.x must
     ...
     * failed. If this is the first validation in the list to fail, this
     * reason, as well as the corresponding HTTP response code, are used in the
     * HTTP response to the client. The currently supported reasons are:
