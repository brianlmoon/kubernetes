...
class ServicePort extends \Moonspot\Kubernetes\BaseObject {
     ...
     *   * 'kubernetes.io/h2c' - HTTP/2 prior knowledge over cleartext as
     * described in
     ...
     */
    public ?IntOrString $targetPort = null;

    public function __construct() {
        $this->targetPort = new IntOrString();
    }
}
