...
class PersistentVolumeClaimSpec extends \Moonspot\Kubernetes\BaseObject {
     ...
     * some installed volume populator or dynamic provisioner. This field will
     * replace the functionality of the DataSource field and as such if both
     * fields are non-empty, they must have the same value. For backwards
     * compatibility, both fields (DataSource and DataSourceRef) will be set to
