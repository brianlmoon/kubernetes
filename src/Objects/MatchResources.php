...
use Moonspot\Kubernetes\Objects\Sets\NamedRuleWithOperationsSet;

class MatchResources extends \Moonspot\Kubernetes\BaseObject {
     ...
     */
    public ?NamedRuleWithOperationsSet $excludeResourceRules = null;
     ...
     * the ValidatingAdmissionPolicy matches. The policy cares about an
     * operation if it matches _any_ Rule.
     */
    public ?NamedRuleWithOperationsSet $resourceRules = null;

    public function __construct() {
        $this->excludeResourceRules = new NamedRuleWithOperationsSet();
        $this->namespaceSelector = new LabelSelector();
        $this->objectSelector = new LabelSelector();
        $this->resourceRules = new NamedRuleWithOperationsSet();
    }
}
