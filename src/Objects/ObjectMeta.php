...
use Moonspot\Kubernetes\Objects\Sets\ManagedFieldsEntrySet;
use Moonspot\Kubernetes\Objects\Sets\OwnerReferenceSet;

class ObjectMeta extends \Moonspot\Kubernetes\BaseObject {
     ...
     */
    public ?Time $creationTimestamp = null;
     ...
     * set, graceful deletion of the object has not been requested.
     * 
     * Populated by the system when a graceful deletion is requested.
     * Read-only. More info:
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public ?Time $deletionTimestamp = null;
     ...
     * responsible for the first finalizer in the list is waiting for a signal
     ...
     */
    public ?ManagedFieldsEntrySet $managedFields = null;
     ...
     */
    public ?OwnerReferenceSet $ownerReferences = null;
    ...
    public function __construct() {
        $this->creationTimestamp = new Time();
        $this->deletionTimestamp = new Time();
        $this->finalizers = new StringSet();
        $this->managedFields = new ManagedFieldsEntrySet();
        $this->ownerReferences = new OwnerReferenceSet();
    }
}
