...
use Moonspot\Kubernetes\Objects\Sets\WeightedPodAffinityTermSet;
use Moonspot\Kubernetes\Objects\Sets\PodAffinityTermSet;

class PodAntiAffinity extends \Moonspot\Kubernetes\BaseObject {
     ...
     * preferred.
     */
    public ?WeightedPodAffinityTermSet $preferredDuringSchedulingIgnoredDuringExecution = null;
     ...
     */
    public ?PodAffinityTermSet $requiredDuringSchedulingIgnoredDuringExecution = null;

    public function __construct() {
        $this->preferredDuringSchedulingIgnoredDuringExecution = new WeightedPodAffinityTermSet();
        $this->requiredDuringSchedulingIgnoredDuringExecution = new PodAffinityTermSet();
    }
}
