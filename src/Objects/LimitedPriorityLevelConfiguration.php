...
class LimitedPriorityLevelConfiguration extends \Moonspot\Kubernetes\BaseObject {
     ...
     * is a limit on the number of requests of this priority level that may be
     ...
     * 
     *             ACV(l) = ceil( SCL * ACS(l) / ( sum[priority levels k]
     * ACS(k) ) )
     * 
     * bigger numbers of ACS mean more reserved concurrent requests (at the
     * expense of every other PL). This field has a default value of 30.
     */
    public ?int $assuredConcurrencyShares = null;
