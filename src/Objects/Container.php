...
class Container extends \Moonspot\Kubernetes\BaseObject {
     ...
     * pod. This field may only be set for init containers, and the only
     * allowed value is "Always". For non-init containers or when this field is
     * not specified, the restart behavior is defined by the Pod's restart
