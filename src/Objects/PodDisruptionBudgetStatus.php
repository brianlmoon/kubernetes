...
class PodDisruptionBudgetStatus extends \Moonspot\Kubernetes\BaseObject {

    /**
     * Conditions contain conditions for PDB. The disruption controller sets
     * the DisruptionAllowed condition. The following are known values for the
     ...
     *                     required by the PodDisruptionBudget. No disruptions
     * are
     *                     allowed and the status of the condition will be
     * False.
