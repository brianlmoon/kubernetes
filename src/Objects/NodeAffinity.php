...
use Moonspot\Kubernetes\Objects\Sets\PreferredSchedulingTermSet;

class NodeAffinity extends \Moonspot\Kubernetes\BaseObject {
     ...
     */
    public ?PreferredSchedulingTermSet $preferredDuringSchedulingIgnoredDuringExecution = null;
    ...
    public function __construct() {
        $this->preferredDuringSchedulingIgnoredDuringExecution = new PreferredSchedulingTermSet();
