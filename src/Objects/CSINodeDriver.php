...
class CSINodeDriver extends \Moonspot\Kubernetes\BaseObject {
     ...
     * given node as "node1", but the storage system may refer to the same node
     * as "nodeA". When Kubernetes issues a command to the storage system to
     * attach a volume to a specific node, it can use this field to refer to
     * the node name using the ID that the storage system will understand, e.g.
