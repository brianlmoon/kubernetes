...
class APIVersions extends \Moonspot\Kubernetes\BaseObject {

    public const KIND = 'APIVersions';
     ...
     */
    public ServerAddressByClientCIDRSet $serverAddressByClientCIDRs;

    /**
     * versions are the api versions that are available.
     */
    public StringSet $versions;

    public function __construct() {
        $this->apiVersion = $this::VERSION;
        $this->kind = $this::KIND;
        $this->serverAddressByClientCIDRs = new ServerAddressByClientCIDRSet();
        $this->versions = new StringSet();
    }
}
