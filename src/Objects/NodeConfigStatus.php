...
class NodeConfigStatus extends \Moonspot\Kubernetes\BaseObject {
    ...
    public function __construct() {
        $this->active = new NodeConfigSource();
        $this->assigned = new NodeConfigSource();
        $this->lastKnownGood = new NodeConfigSource();
    }
}
